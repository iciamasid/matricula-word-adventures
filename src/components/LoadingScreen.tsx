...
const LoadingScreen: React.FC<LoadingScreenProps> = ({
  ...
  return <motion.div initial={{
    ...
    opacity: 0
  }} className="fixed inset-0 flex flex-col items-center justify-center backdrop-blur-sm z-50 bg-transparent">
      <motion.div className="max-w-md w-full px-4 flex flex-col items-center" initial={{
      scale: 0.9
    }} animate={{
      scale: 1
    }} transition={{
      ...
      damping: 25
        ...
        <img src="/lovable-uploads/9e7f018b-48ce-4158-acf0-ddcc7e2b4804.png" alt="Matriculabra Cadabra" className="w-full max-h-60 object-contain mb-8" />
