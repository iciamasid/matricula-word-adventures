    ...
    >
      ...
      <div className="flex justify-center items-center ml-8">
        <div className="text-center">
          <motion.span 
            className={`text-gray-800 ${isMobile ? "text-4xl" : "text-5xl"} font-bold tracking-wider kids-text`}
          ...
          <motion.span 
            className={`text-purple-700 ml-2 ${isMobile ? "text-4xl" : "text-5xl"} font-bold tracking-wider kids-text`}
            animate={isAnimating ? { y: [0, -2, 0, 2, 0] } : {}}
