...
const WorldTourProgress = () => {
  ...
  return (
    <motion.div className="w-full max-w-md mx-auto" whileHover={{
      scale: 1.02
    }} transition={{
      type: "spring",
      stiffness: 400
      ...
      <Card className={`w-full ${panelBgColor} ${borderColor} shadow-lg`}>
        <CardContent className="p-6">
          <div className="text-center mb-4">
            ...
            <p className="text-xl my-0 text-purple-800 font-medium">
              {isEnglish ? "Click on the flags and explore that country!" : "¡Pincha sobre las banderas y explora ese país!"}
            </p>
            <p className={`text-xl font-bold ${textColor} kids-text mt-3`}>
