...
const DrawControls: React.FC<DrawControlsProps> = ({
  ...
  return <div className="flex flex-col sm:flex-row justify-between gap-4">
      ...
      <Button onClick={onClear} variant="outline" disabled={isPlaying || !canvasReady || isInitializing} className="border-red-300 kids-text px-4 py-3 rounded-xl bg-red-600 hover:bg-red-500 text-slate-50 text-2xl font-normal">
