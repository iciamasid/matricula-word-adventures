  ...
  return (
    <div className="w-full grid grid-cols-3 gap-4">
      ...
      <Button 
        ...
        className={`kids-text text-white ${isDrawing ? "bg-green-700 hover:bg-green-800" : "bg-green-600 hover:bg-green-700"} text-lg font-normal py-6`}
      >
      ...
      <Button 
        ...
        className="text-white kids-text text-lg font-normal py-6 bg-amber-500 hover:bg-amber-400"
      >
