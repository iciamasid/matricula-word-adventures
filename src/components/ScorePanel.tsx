  ...
  return <div className="w-full grid grid-cols-2 gap-3 my-2">
      ...
      scale: 1.03
        ...
        <div className="flex items-center p-3">
          ...
          <div className="flex flex-col">
            <p className={`text-xs uppercase ${textColor} font-bold`}>{t("kms")}</p>
            <h2 className="kids-text font-bold flex items-baseline text-3xl text-violet-900">
              {score} 
      ...
      scale: 1.03
        ...
        <div className="flex items-center p-3">
          ...
          <div className="flex flex-col">
            <p className="text-xs uppercase text-white font-bold">{t("level")}</p>
            <h2 className="kids-text text-lg font-bold text-white">
              {level}
            </h2>
          </div>
        </div>
